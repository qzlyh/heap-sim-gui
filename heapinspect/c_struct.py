...
def malloc_state_generator(version='2.27', arch='64'):
    ...
    elif version in ['2.27', '2.28', '2.29', '2.30', '2.31', '2.32', '2.33', '2.34']:
        if arch == '64':
...
def tcache_struct_generator(version='2.27', arch='64'):
    ...
    Returns:
        C_Struct: The corresponding C_Struct.
    '''
    if version in ['2.27','2.29']:
        return C_Struct(tcache_perthread_struct, arch)
    elif version in ['2.31','2.32','2.33','2.34']:
        return C_Struct(tcache_perthread_struct_31, arch)
